...
my $cmd="f:\\iw-home\\TeamSite\\bin\\iwextattr.exe -s TeamSite/Metadata/global_content_type='core'  $fname";
...
my $cmd4="f:\\iw-home\\TeamSite\\bin\\iwextattr.exe -s TeamSite/Metadata/target_languages='en-gb,es-es, fr-fr,pt-br'   $fname";
my $cmd5="f:\\iw-home\\TeamSite\\bin\\iwextattr.exe -s TeamSite/Metadata/target_languages/en-gb='y'  $fname";
my $cmd6="f:\\iw-home\\TeamSite\\bin\\iwextattr.exe -s TeamSite/Metadata/target_languages/es-es='y'  $fname";
